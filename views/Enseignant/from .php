...
<head>
    <title>Formulaire ajout énseignan</title>
</head>

<body>
    <h1>Formulaire ajout énseignant</h1>
    <a href="../../controllers/EnseiganttCtrl.php?action=liste" >Go to students list</a> <br >
            ...
            <td>
               <!-- H <input type="radio" name="sexe"> 
                ...
                <select name="sexe" required>
                    <option value="">Veuillez choisir le sexe de l'énseignant</option>
